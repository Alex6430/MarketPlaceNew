...
urlpatterns = [
                  ...
                  path('home/tire/', views.car_tire, name='car_tire'),
                  path('home/oil/', views.car_oil, name='car_oil'),
                  path('home/disk/', views.car_disk, name='car_disk'),
                  path('home/Akkym/', views.car_akkym, name='car_akkym'),
