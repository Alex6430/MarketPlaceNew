...
class NameRequest(models.Model):
    id_status = models.IntegerField(db_column='ID_Status', primary_key=True)  # Field name made lowercase.
...
class NameCategoryProduct(models.Model):
    id_category = models.IntegerField(db_column='ID_Category', primary_key=True)  # Field name made lowercase.
...
class Product(models.Model):
    id_product = models.IntegerField(db_column='ID_Product', primary_key=True)  # Field name made lowercase.
...
class Request(models.Model):
    id_request = models.IntegerField(db_column='ID_Request', primary_key=True)  # Field name made lowercase.
